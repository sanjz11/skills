...
name: dotnet-adapter
description: >-
  Map Core Design Model IR to .NET / ASP.NET Core design artifacts. Use only in
  Technology Adapter Agent when technology_context.profileId is dotnet.
---
...
- `src/output_workflow/Application/Design.md` — includes legacy migration pseudo-code in **C#** with traceability
